            ...
            <div class="view-content">
              ...
              <ul>
                ...
                <li><strong>Phone :</strong>
                 ...
                 <li><strong>Delivery DateTime :</strong>
                  <?php echo $view['delivery_datetime']; ?>
                </li>
              ...
              <div class="payment-screenshot">
                ...
                <a href="../uploads/payments/<?php echo $view['upload_file']; ?>" target="_blank">
                  <img src="../uploads/payments/<?php echo $view['upload_file'];?>" alt="Payment Screenshot" style="max-width: 300px; height: auto;">
                </a>
              </div>
              <div class="table-responsive">
                <table class="table table-bordered">
...
<?php
    ...
    if (isset($_POST['order_receipt'])) {
      $id = $_POST['id'];
      $receipt = ordersInfoView($con, $id);
    ?>
      <div class="receipt-order">
        <div class="container">
          <a class="btn btn-light my-2" href="./edit-orders.php"><i class="fa fa-backward" aria-hidden="true"></i>&nbsp;Back</a>
          <div class="col-md-8 mx-auto">
            <h1>Receipt for Order <?php echo $receipt['orders_number'] ?></h1>
            <div class="receipt-content p-3 border">
              <h2>Billing details</h2>
              <ul>
                <li><strong>Full Name :</strong>
                  <?php echo $receipt['name_customer']; ?>
                </li>
                <li><strong>Email :</strong>
                  <?php echo $receipt['email_customer']; ?>
                </li>
                <li><strong>Phone :</strong>
                  <?php echo $receipt['phone_customer']; ?>
                </li>
                 <li><strong>Delivery Address :</strong>
                  <?php echo $receipt['delivery_address']; ?>
                </li>
                 <li><strong>Delivery DateTime :</strong>
                  <?php echo $receipt['delivery_datetime']; ?>
                </li>
                <li><strong>Note :</strong>
                  <?php echo $receipt['note_customer']; ?>
                </li>
              </ul>
              <div class="table-responsive">
                <table class="table table-bordered">
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <?php echo $receipt['product_quantity']; ?>
                      </td>
                      <td>
                        <?php echo $receipt['subtotal']; ?>
                      </td>
                    </tr>
                    <tr class="text-bg-light">
                      <td colspan="2" class="text-end"><strong>Subtotal</strong></td>
                      <td><strong><?php echo $receipt['subtotal']; ?></strong></td>
                    </tr>
                    <tr class="text-bg-light">
